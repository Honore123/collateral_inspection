                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group form-group-sm mb-0 clearfix">
                                                <div class="d-inline">
                                                    <input type="radio" name="encumbranes" id="encumbranes" value="Yes" @if($earth->encumbranes == "Yes") checked @endif >
                                                    <label for="encumbranes"> Yes</label>
                                                </div> &nbsp;&nbsp;
                                                <div class="d-inline">
                                                    <input type="radio" name="encumbranes" id="encumbranes" value="No" @if($earth->encumbranes == "No") checked @endif >
                                                    <label for="encumbranes"> No</label>
                                                </div>
                                                <div class="d-inline">
                                                    <input type="radio" name="encumbranes" id="encumbranes" value="Not Sure" @if($earth->encumbranes == "Not Sure") checked @endif >
                                                    <label for="encumbranes"> Not sure</label>
                                                </div>
                                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group form-group-sm mb-0 clearfix">
                                                <div class="d-inline">
                                                    <input type="radio" name="mortgaged" id="mortgaged" value="Yes" @if($earth->mortgaged == "Yes") checked @endif >
                                                    <label for="mortgaged"> Yes</label>
                                                </div> &nbsp;&nbsp;
                                                <div class="d-inline">
                                                    <input type="radio" name="mortgaged" id="mortgaged" value="No" @if($earth->mortgaged == "No") checked @endif >
                                                    <label for="mortgaged"> No</label>
                                                </div>
                                                <div class="d-inline">
                                                    <input type="radio" name="mortgaged" id="mortgaged" value="Not Sure" @if($earth->mortgaged == "Not Sure") checked @endif >
                                                    <label for="mortgaged"> Not sure</label>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            $('#propertyUPI').mask('0/00/00/00/0000');
        });
    </script>
    <script>
        $(document).ready(function(){
