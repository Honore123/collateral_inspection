                    ...
                    <form id="addEarthForm" method="POST" enctype="multipart/form-data" class="inpt">
                        ...
                        <div class="form-row form-horizontal">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input class="form-control form-control-sm {{ $errors->has('propertyUPI') ? 'is-invalid' : '' }}" type="text" name="propertyUPI" id="propertyUPI" value="{{ old('propertyUPI', '') }}" placeholder="1/11/11/11/1111" required>
                        ...
                        <div class="form-row form-horizontal mb-o">
                            <div class="form-group col-sm-4">
                                ...
                                <div class="checkbox ml-1">
                                    <label class="col-form-label-sm"><input type="radio" name="encumbranes" value="Yes"> Yes</label>
                                    &nbsp;
                                    <label class="col-form-label-sm"><input type="radio" name="encumbranes" value="No"> No</label>
                                </div>
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <div class="checkbox ml-1">
                                    <label class="col-form-label-sm"><input type="radio" name="mortgaged" value="Yes"> Yes</label>
                                    &nbsp;
                                    <label class="col-form-label-sm"><input type="radio" name="mortgaged" value="No"> No</label>
                                </div>
